...
class RegisterMedecinScreen extends StatefulWidget {
    const RegisterMedecinScreen({Key? key}) : super(key: key);
    ...
    Future<void> _register() async {
        ...
        final success = await authProvider.registerMedecin(
